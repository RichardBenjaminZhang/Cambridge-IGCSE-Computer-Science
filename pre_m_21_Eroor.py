...
Trians_Up_Tickets[IndexUp]=Trians_Up_Tickets[IndexUp]-NumTickets
Trians_Down_Tickets[IndexDown]=Trians_Down_Tickets[IndexDown]-NumTickets
for count in range(0,4):
    if Trians_Up_Tickets[count]==0:
        Trians_Up_Tickets[count]=str（Trians_Up_Tickets[count]）
        Trians_Up_Tickets[count]="Closed"
    if Trians_Down_Tickets[count]==0:
        Trians_Down_Tickets[count]=str（Trians_Down_Tickets[count]）
        Trians_Down_Tickets[count]="Closed"
